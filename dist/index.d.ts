...
export default class LRUCache<K, V> {
    ...
    private [MAX_AGE];
    private [DISPOSE];
    private [NO_DISPOSE_ON_SET];
    private [UPDATE_AGE_ON_GET];
    private [LENGTH];
    private [LRU_LIST];
    private [MAX];
    private [CACHE];
...
declare class LEntry {
    key: any;
    value: any;
    length: any;
    now: any;
    maxAge: any;
    constructor(key: any, value: any, length: any, now: any, maxAge: any);
}
